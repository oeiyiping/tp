...
public class PersonUtil {
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        ...
        descriptor.getCompany().ifPresent(company -> sb.append(PREFIX_COMPANY).append(" ").append(company.value).append(" "));
        descriptor.getJobTitle().ifPresent(jobTitle -> sb.append(PREFIX_JOB_TITLE).append(" ").append(jobTitle.value).append(" "));
        descriptor.getAddress().ifPresent(address -> sb.append(PREFIX_ADDRESS).append(" ").append(address.value).append(" "));
        descriptor.getRemark().ifPresent(remark -> sb.append(PREFIX_REMARK).append(" ").append(remark.value).append(" "));
